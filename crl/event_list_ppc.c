...
void event_list_ppc__init (rolp)
     rolParam rolp;
{
...
/* # 9 "event_list_ppc.c" 2 */
/* # 1 "/adaqfs/coda/2.6.2/common/include/EVENT_source.h" 1 */
...
(((*rol->dabufpi)&0xff0000)>>16); if (__the_event__) __the_event__->nevent = input_event__->nevent; rol->dabufpi++; INPUT = 
rol->dabufpi; } ; { 
