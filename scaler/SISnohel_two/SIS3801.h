 ...
 * Modifications:                                                       *
 *                                                                      *  
 *  R. Michaels,  Sept 2002     ab3 and ab5 are G0 scalers              *
 *  R. Michaels,  Sept 2003     Let NUMSCALERS = 1 now                  *
 *  R. Michaels,   Oct 2003     Start using sysBusToLocalAddrs          *
 *                              Reduced to 1 helicity scaler.           *
 *                                                                      *
 ************************************************************************/
