...
/* NUMSCALER = number of scaler units (3801 count twice)
   NUMBLOCKS = number of 16-channel blocks = 
     num_1151_scalers + num_v560_scalers 
           + 2*num_str7200_scalers + 2*num_str3800_scalers
           + 4*num_str3801_scalers
   (4* for 3801 because each has 32 channels and is split
    into + and - helicity).
