...
STATUS checkLockAutoLED() {
  ...
  // if(righthrs){
    flexioWriteMask(0,auto_led_diff_enable_flag);
    flexioWriteMask(0,auto_led_base_enable_flag);
    // } else if(lefthrs) {
...
int enableDiffAutoLED(int state) {
  ...
  // if(righthrs){
    flexioWriteMask(state,auto_led_diff_enable_flag);
    //} else if(lefthrs) {
    // if(state==1)      set_tir_oport(auto_led_diff_flag);
    // else if(state==0) unset_tir_oport(auto_led_diff_flag);  
    // }
  setDataSCAN(2,state);
  return(state);
}
...
int enableBaseAutoLED(int state) {
  ...
  //write state to enable diff signal
  // if(righthrs){
    flexioWriteMask(state,auto_led_base_enable_flag);
    // }else if(lefthrs){
...
int getStateDiffAutoLED() {
  int value;
  value = flexioGetOutputBit(auto_led_diff_enable_flag);
  return(value);
}

int getStateBaseAutoLED() {
  int value;
  value = flexioGetOutputBit(auto_led_base_enable_flag);
  return(value);
}
...
STATUS cycleAutoLED() {
  ...
  //  int withbeam[]={46500,44500,42500,45500,28500,46500,42500,38500,44500,45500,30500,42500,38500,46500,44500}; //50 uA
  int withbeam[]={46500,45500,44500,27500,40500,46500,42500,44000,45500,36500,44500,46000,43500,44500,40500,42500,44500,46500,41500,34500};  
  // for no beam 
  int withoutbeam[]={50500,49500,43500,27500,44000,46500,41500,37500,45500,45000,51500,30500,48500,44500,36500,42500,40500,46000,47500,34500};  
 // 15 uA beam  
 //int withoutbeam[]={48500,49500,43500,27500,44000,46500,41500,37500,45500,45000,49500,30500,48500,44500,36500,42500,40500,46000,47500,34500};  
