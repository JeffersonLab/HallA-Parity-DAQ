...
#include "/adaqfs/home/apar/devices/flexio/KentVers/flexioLib.h"
...
LOCAL int bmw_seq_amp_1[MAX_SEQS]  = {  85,  85,  85,  85,  85,  85,  85, 85};
...
int bmw_steps_per_pause  =   60; /* Number of steps to rest after last object, 60 sec = 1 min*/
